 ...
 */
final class Version20230502161514 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `character` (id INT AUTO_INCREMENT NOT NULL, game_master_id INT DEFAULT NULL, player_id INT NOT NULL, info_id INT NOT NULL, profession_id INT DEFAULT NULL, points_id INT DEFAULT NULL, name VARCHAR(120) NOT NULL, is_private TINYINT(1) NOT NULL, profession_lv SMALLINT DEFAULT NULL, INDEX IDX_937AB034C1151A13 (game_master_id), INDEX IDX_937AB03499E6F5DF (player_id), UNIQUE INDEX UNIQ_937AB0345D8BC1F8 (info_id), INDEX IDX_937AB034FDEF8996 (profession_id), UNIQUE INDEX UNIQ_937AB034DF69572F (points_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE points (id INT AUTO_INCREMENT NOT NULL, fate SMALLINT NOT NULL, luck SMALLINT NOT NULL, resolve SMALLINT NOT NULL, resilience SMALLINT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
