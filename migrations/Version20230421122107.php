 ...
 */
final class Version20230421122107 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `character` (id INT AUTO_INCREMENT NOT NULL, game_master_id INT DEFAULT NULL, player_id INT NOT NULL, name VARCHAR(120) NOT NULL, INDEX IDX_937AB034C1151A13 (game_master_id), INDEX IDX_937AB03499E6F5DF (player_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
