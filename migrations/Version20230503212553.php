 ...
 */
final class Version20230503212553 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE attributes (id INT AUTO_INCREMENT NOT NULL, male_wepons INT NOT NULL, range_wepons INT NOT NULL, strenght INT NOT NULL, resistance INT NOT NULL, initiative INT NOT NULL, agility INT NOT NULL, dexterity INT NOT NULL, intelligency INT NOT NULL, will INT NOT NULL, charisma INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `character` (id INT AUTO_INCREMENT NOT NULL, game_master_id INT DEFAULT NULL, player_id INT NOT NULL, info_id INT NOT NULL, profession_id INT DEFAULT NULL, points_id INT DEFAULT NULL, exp_id INT DEFAULT NULL, attributes_id INT DEFAULT NULL, developments_attributes_id INT NOT NULL, name VARCHAR(120) NOT NULL, is_private TINYINT(1) NOT NULL, profession_lv SMALLINT DEFAULT NULL, INDEX IDX_937AB034C1151A13 (game_master_id), INDEX IDX_937AB03499E6F5DF (player_id), UNIQUE INDEX UNIQ_937AB0345D8BC1F8 (info_id), INDEX IDX_937AB034FDEF8996 (profession_id), UNIQUE INDEX UNIQ_937AB034DF69572F (points_id), UNIQUE INDEX UNIQ_937AB034D26628FA (exp_id), UNIQUE INDEX UNIQ_937AB034BAAF4009 (attributes_id), UNIQUE INDEX UNIQ_937AB034E2B6055F (developments_attributes_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE developments_attributes (id INT AUTO_INCREMENT NOT NULL, male_wepons INT NOT NULL, range_wepons INT NOT NULL, strenght INT NOT NULL, resistance INT NOT NULL, initiative INT NOT NULL, agility INT NOT NULL, dexterity INT NOT NULL, intelligency INT NOT NULL, will INT NOT NULL, charisma INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE `character` ADD CONSTRAINT FK_937AB034BAAF4009 FOREIGN KEY (attributes_id) REFERENCES attributes (id)');
        $this->addSql('ALTER TABLE `character` ADD CONSTRAINT FK_937AB034E2B6055F FOREIGN KEY (developments_attributes_id) REFERENCES developments_attributes (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `character` DROP FOREIGN KEY FK_937AB034BAAF4009');
        $this->addSql('ALTER TABLE `character` DROP FOREIGN KEY FK_937AB034E2B6055F');
        $this->addSql('DROP TABLE attributes');
        $this->addSql('DROP TABLE `character`');
        $this->addSql('DROP TABLE character_info');
        $this->addSql('DROP TABLE developments_attributes');
